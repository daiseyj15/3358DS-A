...
{
   // to be implemented as part of Assignment Opt01
     Item *oldData = data;
...
{
   // to be implemented as part of Assignment Opt01
    size_type home = hash(cStr);

    size_type location = home;

    size_type i = 1;



    while(data[location].word[0] != '\0'){

        if(!strcmp(data[location].word , cStr)){
...
{
   if (x == 1) return false; // by common (won't-matter-to-us) convention
